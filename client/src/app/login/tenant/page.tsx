...
import tenant from '../../../images/tenant_logo.png';
...
const TenantLogin = () => {
  const countries = [
    { code: 'AD', label: 'Supertech Eco Village 1', phone: 'Greater Noida West' },
  ];
    return <>
          ...
          <Container maxWidth="xs">   
            <Box component="form" onSubmit={()=>{}} noValidate sx={{ mt: 1 }}>
                <Box className='center_items'>
                    <Image src={tenant} alt={"owner-logo"} height={100} width={100}/>
                </Box>
